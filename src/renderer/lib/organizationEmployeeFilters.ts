...
// 用户甲 5/25 PM:
// V2.1 早期有一批 mock 假员工 (益语管理员/成员甲/成员乙/一朔/佳乐/大周, 邮箱 example.org 示例域名),
// 之前用 LEGACY_SIMULATION_NAMES + IDS + EMAILS 黑名单过滤.
// 现在:
//   1. 成员甲 是真 AI 同事 (bot_members 表, primaryRole='ai_agent'), 不能过滤
 ...
 * 用户甲 5/25 PM 钦定: 真员工/真 bot 名字都尊重, 不再 hard-code 黑名单.
 */
