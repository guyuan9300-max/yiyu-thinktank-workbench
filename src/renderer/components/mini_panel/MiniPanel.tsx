...
const SAMPLE_TODAY: MiniDay = {
  date: todayIso(),
  events: [
    { id: 'e1', time: '09:30', title: 'A组织 战略对齐会', clientName: 'A组织' },
    { id: 'e2', time: '14:00', title: 'B客户 合同评审', clientName: 'B客户' },
  ],
  tasks: [
    { id: 't1', title: '输出第一版价值观建议稿', done: false, dueLabel: '今天', clientName: 'A组织' },
    { id: 't2', title: '提交理事会汇报简版材料', done: false, dueLabel: '6/10', clientName: 'A组织' },
    { id: 't3', title: '提供更轻量的试点方案及风险控制说明', done: false, dueLabel: '逾期', overdue: true, clientName: 'A组织' },
    { id: 't4', title: '完成存量品牌素材评估', done: true, clientName: 'A组织' },
  ],
};
