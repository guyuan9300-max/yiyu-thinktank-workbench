...
背景:
  ...
  本脚本一次性反查 + 填充. 当前示例工作台只有 1 个 organization, 全设它.
  owner_user_id 默认填 user_admin_demo (管理员甲, admin, 历史导入大概率是他).

策略:
  · organization_id  ← 'org_yiyu_default' (mirror_organizations 唯一一条)
  · owner_user_id    ← 'user_admin_demo' (管理员甲, 主导入人)
  · department_id    ← 'department_gq160gdz' (管理员甲所属部门)
...
DEFAULT_OWNER_USER_ID = "user_admin_demo"
