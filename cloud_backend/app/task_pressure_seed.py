...
QUARTER_GOAL_SUMMARIES = {
    ...
    "Q1-G2": "围绕蓝信封、A组织、C项目形成稳定推进与判断输出。",
...
USER_DIRECTORY = {
    "庆华": {"user_id": "user_qinghua", "email": "member-a@example.org", "password": DEFAULT_SEED_PASSWORD},
    "苏妍": {"user_id": "user_sim_suyan", "email": "suyan@example.org", "password": DEFAULT_SEED_PASSWORD},
    "晨曦": {"user_id": "user_sim_chenxi", "email": "chenxi@example.org", "password": DEFAULT_SEED_PASSWORD},
    "奕鸣": {"user_id": "user_sim_yiming", "email": "yiming@example.org", "password": DEFAULT_SEED_PASSWORD},
    "佳乐": {"user_id": "user_jiale", "email": "member-d@example.org", "password": DEFAULT_SEED_PASSWORD},
    "昊然": {"user_id": "user_sim_haoran", "email": "haoran@example.org", "password": DEFAULT_SEED_PASSWORD},
    "林越": {"user_id": "user_sim_linyue", "email": "linyue@example.org", "password": DEFAULT_SEED_PASSWORD},
    "君昊": {"user_id": "user_sim_junhao", "email": "junhao@example.org", "password": DEFAULT_SEED_PASSWORD},
    "欣宁": {"user_id": "user_sim_xinning", "email": "xinning@example.org", "password": DEFAULT_SEED_PASSWORD},
    "大周": {"user_id": "user_dazhou", "email": "member-e@example.org", "password": DEFAULT_SEED_PASSWORD},
    "罗茜茜": {"user_id": "user_sim_ruoxi", "email": "ruoxi@example.org", "password": DEFAULT_SEED_PASSWORD},
    "柏辰": {"user_id": "user_sim_bochen", "email": "bochen@example.org", "password": DEFAULT_SEED_PASSWORD},
    "舒婷": {"user_id": "user_sim_shuting", "email": "shuting@example.org", "password": DEFAULT_SEED_PASSWORD},
    "嘉译": {"user_id": "user_sim_jiayi", "email": "jiayi@example.org", "password": DEFAULT_SEED_PASSWORD},
    "一朔": {"user_id": "user_yishuo", "email": "member-c@example.org", "password": DEFAULT_SEED_PASSWORD},
    "嘉宁": {"user_id": "user_jianing", "email": "member-b@example.org", "password": DEFAULT_SEED_PASSWORD},
    "秋月": {"user_id": "user_sim_qiuyue", "email": "qiuyue@example.org", "password": DEFAULT_SEED_PASSWORD},
    "泽宇": {"user_id": "user_sim_zeyu", "email": "zeyu@example.org", "password": DEFAULT_SEED_PASSWORD},
    "瑶彤": {"user_id": "user_sim_yaotong", "email": "yaotong@example.org", "password": DEFAULT_SEED_PASSWORD},
    "沐阳": {"user_id": "user_sim_muyang", "email": "muyang@example.org", "password": DEFAULT_SEED_PASSWORD},
}
...
def _upsert_ceo_account(db: Database, organization_id: str, user_id: str, full_name: str) -> None:
    ...
    if exists:
        db.execute(
            ...
            SET organization_id = ?, full_name = ?, email = COALESCE(NULLIF(email, ''), 'admin-demo@example.org'),
        ...
        db.execute(
            ...
            ) VALUES(?, ?, 'admin-demo@example.org', ?, ?, 'admin', 'approved', ?, ?, NULL, NULL, '[]', NULL, NULL, NULL, ?, ?)
            """,
...
def _backup_db(db_path: Path) -> Path:
    ...
    backup_dir = Path("/Users/example_user/.openclaw/workspace/tmp/backups")
...
def main() -> None:
    ...
    parser.add_argument("--ceo-user-id", default="user_admin_demo")
    parser.add_argument("--ceo-name", default="用户甲")
