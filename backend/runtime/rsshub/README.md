...
`<id>` 是公众号的英文 ID，比如「A组织」的 `ricifoundation`。

### 怎么查公众号英文 ID

1. 微信里搜公众号「A组织」→ 进主页 → 点右上 ··· → "查看公众号"
2. 看到的英文字串就是 ID
3. 或者搜狗搜 `weixin.sogou.com/weixin?type=1&query=A组织`，结果里有「微信号: ricifoundation」字样
