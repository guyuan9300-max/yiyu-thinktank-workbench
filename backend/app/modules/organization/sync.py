...
def _normalize_user(
    ...
    return {
        ...
        "visibility_scope": employee.get("visibilityScope") or (binding.get("visibilityScope") if binding else None) or "self",
        "management_title_id": employee.get("managementTitleId") or None,
        "management_title_name": employee.get("managementTitleName") or None,
