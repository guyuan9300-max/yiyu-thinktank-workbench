...
- index: 1, 2, 3, ...
- action: 庆华要做的具体动作 (动词短语, 20-60 字). 例: "写一份测试机构A客户背景档案 (含组织介绍 + 项目清单)"
- basis: 这一步基于什么 (上下文/参考/前置 step 产出, 10-80 字). 例: "数据中心已有测试机构A合同 2 份 + 测试机构A官网公开资料 + 益语 2025-2026 服务记录"
...
6. 如果用户提到具体客户 (如"测试机构A"), action 里要带客户名, 不要写成"撰写介绍"这种泛指
