...
- 一个陈述只对**这家客户特定**成立 → 抽
- 例: "公益基金会需要捐赠" 不抽 / "日慈基金会主要捐赠来自腾讯基金会" 抽
- 例: "心理健康教育对儿童重要" 不抽 / "日慈心盛计划针对乡村 6-14 岁儿童" 抽
...
**判定方法**: 写每个段落时, 在脑子里检查"有没有提到角色变化 / 项目合并 / 产品命名"3 类, 答有 → 必抽 (即使原文一句话也要抽出对应 fact)。

# 输出格式 (严格 JSON)
{
  "extracted_facts": [
    {
      "subject_text": "<主语,例: 日慈基金会 / 张真>",
