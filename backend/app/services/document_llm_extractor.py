...
- 用户甲 5/22 铁律: 通识不抽取
- 用户甲 5/22 信息商: AI 抽出新事实时调 IngestPipeline.detect_update_relation
...
- 一个陈述只对**这家客户特定**成立 → 抽
- 例: "公益基金会需要捐赠" 不抽 / "A组织主要捐赠来自腾讯基金会" 抽
- 例: "心理健康教育对儿童重要" 不抽 / "A组织心盛计划针对乡村 6-14 岁儿童" 抽
...
## 7. ★ 强制抽取 3 大类 (用户甲 5/22 M-C.2 加, 防 LLM 漏关键事实)
...
class DocumentLLMExtractor:
    ...
    def extract_from_document(
        ...
        *,
        ...
        # 根据 v2_documents.kind 映射 source_type (用户甲 5/22 渠道驱动)
