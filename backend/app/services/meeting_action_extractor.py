...
抽取规则 (按置信度从高到低):
  P0 · @标注: 行尾含 "@张真" "@顾源源" 等 → 高置信
  P1 · 将/会/需: "顾源源将牵头...", "张真需在7月..." → 中置信
...
# 例: "撰写价值观调研问题,并组织核心团队进行线上/线下讨论。 @顾源源"
# 例: "安排品牌与设计人员对接顾源源,启动品牌更新工作。 @张真 @严斌"
...
def _clean_actor(at_segment: str) -> str:
    """从 '@顾源源 @张真 @严斌' 提取 '顾源源,张真,严斌', 过滤机构名/章节代词."""
