...
FILES_20 = [
    # 合同 3 份
    {
        "file_name": "A组织-示例团队-战略陪伴主合同_v1_20260101.docx",
    ...
    {
        "file_name": "A组织-青年支持计划合作协议_v1_20260215.docx",
        "expected_type": "contract",
        "expected_role": "client_official",
        "text_excerpt": (
            "甲方:A组织 乙方:示例工作台\n"
    ...
    {
        "file_name": "B客户-示例团队-乡村教育帮扶服务合同_20260301.docx",
        "expected_type": "contract",
        "expected_role": "client_official",
        "text_excerpt": (
            "甲方:B客户(中华少年儿童慈善救助基金会某项目)\n"
            "乙方:示例工作台\n"
            "签订日期:2026 年 3 月 1 日\n"
            "项目名称:乡村教育帮扶项目\n"
            "服务金额:320 万元\n"
    ...
    # 补充协议 2 份
    {
        "file_name": "A组织-青年支持计划补充协议_v2_20260518.docx",
        "expected_type": "supplementary_agreement",
        "expected_role": "client_official",
        "text_excerpt": (
            "本补充协议系对 2026 年 2 月 15 日 《A组织-青年支持计划合作协议》 的修订.\n"
            "甲方:A组织 乙方:示例工作台\n"
            "签订日期:2026 年 5 月 18 日\n\n"
            "经双方协商, 自本补充协议生效之日起, 青年支持计划项目预算调整为 300 万元,\n"
    ...
    {
        "file_name": "A组织-安心妈妈项目附件协议_v1_20260520.docx",
        "expected_type": "supplementary_agreement",
        "expected_role": "client_official",
        "text_excerpt": (
            "甲方:A组织 乙方:示例工作台\n"
    ...
    # 项目方案 3 份
    {
        "file_name": "A组织-青年支持计划项目方案_v1_20260208.docx",
    ...
    {
        "file_name": "A组织-青年支持计划项目方案_v2_20260518.docx",
        "expected_type": "proposal",
        "expected_role": "client_official",
        "text_excerpt": (
            "项目名称:青年支持计划(v2 调整版)\n"
    ...
    {
        "file_name": "A组织-安心妈妈试点方案_v1_20260519.docx",
        "expected_type": "proposal",
        "expected_role": "client_official",
        "text_excerpt": (
            "项目名称:安心妈妈家长项目\n"
    ...
    # 会议纪要 3 份
    {
        "file_name": "A组织-青年支持计划战略复盘会议纪要_20260522.docx",
        "expected_type": "meeting_minute",
        "expected_role": "client_official",
        "text_excerpt": (
            "2026 年 5 月 22 日, A组织与示例工作台召开青年支持计划战略复盘.\n"
            "负责人甲理事长提出战略调整: 心盛维持 12 所, 不再扩到 20 所. 第二曲线转向安心妈妈.\n"
            "强哥担忧 5 所一起开太冒险, 建议先 2 所验证.\n"
            "杨岩冰提出运营约束: 6 人团队同时维持心盛 12 所 + 安心妈妈 5 所有压力.\n"
            "负责人甲承诺 5/30 前给最终预算方案, 强哥承诺 5/28 前给试点学校名单."
        ),
    },
    {
        "file_name": "B客户-乡村教育帮扶季度复盘_20260520.docx",
        "expected_type": "meeting_minute",
        "expected_role": "client_official",
        "text_excerpt": (
            "2026 年 5 月 20 日, B客户 与示例团队召开乡村教育帮扶季度复盘.\n"
    ...
    {
        "file_name": "A组织-月度沟通纪要_20260408.docx",
        "expected_type": "meeting_minute",
        "expected_role": "client_official",
        "text_excerpt": (
            "2026 年 4 月 8 日月度沟通会.\n"
            "青年支持计划 3 月已经入校 8 所学校, 学生反馈良好.\n"
            "下月计划再增 4 所. 各方运转正常."
        ),
    },
    # 年报/章程 2 份
    {
        "file_name": "A组织-2025 年度报告.docx",
    ...
    {
        "file_name": "B客户-基金会章程_20240101.docx",
    ...
    # 我方反馈 2 份
    {
        "file_name": "示例团队-关于青年支持计划扩张节奏的反馈_20260510.docx",
        "expected_type": "feedback_doc",
        "expected_role": "yiyu_produced",
        "text_excerpt": (
            "示例团队顾问反馈: 不建议青年支持计划一开始扩到 20 所.\n"
            "理由: 服务质量难保, 师资储备不足. 建议先 3 所试点验证."
        ),
    },
    {
        "file_name": "示例团队-关于安心妈妈项目设计建议_20260519.docx",
        "expected_type": "feedback_doc",
        "expected_role": "yiyu_produced",
        "text_excerpt": (
            "示例团队建议: 安心妈妈先 2 所验证, 不直接 5 所铺开.\n"
    ...
    # 预算表 1 份
    {
        "file_name": "A组织-2026 年项目预算表_v2_20260519.xlsx",
        "expected_type": "budget_table",
        "expected_role": "client_official",
        "text_excerpt": (
            "2026 年A组织项目预算 (v2 调整版).\n"
            "青年支持计划: 300 万 (原 480 万)\n"
            "安心妈妈试点: 180 万 (新增)\n"
            "运营储备: 30 万\n"
            "合计: 510 万."
        ),
    ...
    # 客户宣传 1 份
    {
        "file_name": "A组织-青年支持计划对外宣传稿_v1_20260301.docx",
