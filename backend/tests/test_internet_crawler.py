...
def _insert_client(db: Database, client_id: str, name: str = "C项目") -> None:
    db.execute(
        """
    ...
    pages = {
        "https://www.weiaiqianxing.cn": """
            <html><body>
              ...
              <main>C项目长期关注贵州山区儿童成长与乡村美育支持。</main>
            </body></html>
        """,
        "https://www.weiaiqianxing.cn/sys-nd/29.html": """
            <html>
              ...
              <body>
                ...
                <p>发布时间：2024-05-12</p>
                <p>C项目联合合作伙伴在贵州山区学校推进音乐课堂建设，目标是补足乡村学校美育资源。</p>
...
def test_readiness_action_queues_internet_enrichment_job(tmp_path: Path, monkeypatch) -> None:
    ...
    with TestClient(app) as client:
        ...
        assert "C项目 大山里的音乐课堂" in row["payload_json"]
