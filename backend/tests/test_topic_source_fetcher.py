...
def test_fetch_preferred_source_hits_parses_list_page_details(monkeypatch):
    ...
    <html>
      <body>
        <a href="/abutment/detail/16463.html">基金会秘书长：这里有三个好项目，ESF喊你来！</a>
    ...
    <html>
      <head>
        <title>基金会秘书长：这里有三个好项目，ESF喊你来！</title>
        <meta name="description" content="这是一条从详情页提取的摘要。" />
      </head>
      <body>
        <div class="source">来源：<span>行业论坛</span></div>
