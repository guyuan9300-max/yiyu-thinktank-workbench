...
def test_growth_workbench_understands_agreement_task(tmp_path: Path):
    ...
    created_task = client.post(
        "/api/v1/tasks",
        json={
            "title": "下午找 B客户 沟通战略合作协议",
            "desc": "需要和联系人甲老师对齐战略合作协议的边界、待确认点和下一轮修改动作。",
            "priority": "high",
            ...
            "nextAction": "先整理本次必须确认的 3 个条款，再和联系人甲老师沟通",
    ...
    uploaded = client.post(
        ...
        files={"file": ("agreement-draft.md", b"# B客户 \xe5\x8d\x8f\xe8\xae\xae\xe8\x8d\x89\xe6\xa1\x88", "text/markdown")},
        data={"clientId": client_id, "taskTitle": "下午找 B客户 沟通战略合作协议"},
    )
