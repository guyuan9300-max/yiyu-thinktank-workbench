...
def test_public_search_continues_when_one_provider_fails(monkeypatch) -> None:
    ...
    assert results[0].title == "示例工作台 信息公开"


def test_public_search_filters_image_vertical_results() -> None:
    html = """
    <li class="b_algo">
      <h2><a href="https://image.so.com/i?q=%E7%9B%8A%E8%AF%AD%E6%99%BA%E5%BA%93">示例工作台_360图片</a></h2>
      <p>查看全部图片搜索结果。</p>
    </li>
    <li class="b_algo">
      <h2><a href="https://www.yiyu.example/news">示例工作台公开报道</a></h2>
      <p>示例工作台公开报道正文摘要。</p>
    </li>
    """
