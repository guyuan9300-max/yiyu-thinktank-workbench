...
用法：
    # 看建议（默认 dry-run）
    .venv/bin/python scripts/reclassify_tasks_with_llm.py --user user_guyuan

    # 真正写回 db
    .venv/bin/python scripts/reclassify_tasks_with_llm.py --user user_guyuan --apply

    # 限制条数
    .venv/bin/python scripts/reclassify_tasks_with_llm.py --user user_guyuan --limit 20
...
def main():
    ...
    parser.add_argument("--user", required=True, help="user_id (如 user_guyuan)")
