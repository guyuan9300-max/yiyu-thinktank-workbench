...
> 生成: 2026-05-23T10:18:48.479890+00:00 · 耗时 33s
...
| Q2 这些调用有没有产出用户可直接使用的成果? | 是 — 产出 4/10 件: 会议摘要, 会谈任务草稿, 待审批动作, Agent Run Log |
| Q3 用户是否能审批/修改/确认? | 是 — approval_queue_ids=2 + GET /approvals 真暴露 |
| Q4 哪些内容仍缺证据? | clarifications 不足 (期望 ≥ 2), 合同草稿, 会谈提纲, 品牌情报检索, 品牌调整建议, 理事会简版说明, 待澄清问题 |
...
- test_run_id: `v30_internal_6770737a7207`
- POST /meeting-minutes/process: HTTP 200
- response 关键字段:
  - run_id: run_136ee02b966341dd907199e8
  ...
  - elapsed_seconds: 11.714749813079834
...
- test_run_id: `v30_external_48dbe97a3614`
- POST /meeting-minutes/process: HTTP 200
- facts +5 / risks +1 / clarif +1

## Group 3 · 数据缺口主动补

- test_run_id: `v30_gap_387978b09d0a`
- POST /meeting-minutes/process: HTTP 200
