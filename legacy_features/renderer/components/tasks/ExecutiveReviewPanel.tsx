import type { AgentWeeklyDigest, AgentWeeklyPlan, HierarchyReport, ReviewSimulationBundle } from '../../../../src/shared/types';
import { AgentWeeklyDigestPanel } from '../../../../src/renderer/components/tasks/AgentWeeklyDigestPanel';
import { AgentWeeklyPlanPanel } from '../../../../src/renderer/components/tasks/AgentWeeklyPlanPanel';
import { HierarchyReportCard } from '../../../../src/renderer/components/tasks/HierarchyReportCard';
import { WeeklyReviewSimulationPanel } from '../../../../src/renderer/components/tasks/WeeklyReviewSimulationPanel';
